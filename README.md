## Welcome to  [ # Movie Poster Interaction ]  HTML Code Sections
An iMDB concept for movie cards. Side note: the movies seen in the demo doesn’t exist.
## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Movie-Poster-Interaction )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/ZEVKEvE )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Movie-Poster-Interaction )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/movie-poster-interaction/ )
